...
def getPolicyForUser(user_role, tenant_id, region, aws_account_id):
    ...
    if (isSystemAdmin(user_role)):
        ...
        iam_policy = __getPolicyForTenantAdmin(tenant_id, region, aws_account_id)
...
def __getPolicyForTenantAdmin(tenant_id, region, aws_account_id):
    policy = {	
        "Version": "2012-10-17",
        "Statement": [
            {
